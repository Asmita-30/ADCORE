...
// ─── HERO SECTION ─────────────────────────────────────────────────────────────
// ─── HERO SECTION (with rings removed) ─────────────────────────────────────────────
function Hero() {
    ...
    <section id="home" style={{
      ...
      >
        <div style={{
          ...
          {/* CENTER VIDEO - Removed outer rings */}
          <video
            src={VIDEO_SRC}
            autoPlay
            muted
          ...
          {/* Pixel dots - kept these for decoration */}
          {[
  ...
  return (
    <footer style={{ position: "relative", zIndex: 5, background: "rgba(0,5,15,0.95)", borderTop: "1px solid rgba(0,229,255,0.08)", padding: "3rem" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "2rem" }}>
        <div>
          <div style={{ fontFamily: "'Orbitron',monospace", fontSize: "1.2rem", fontWeight: 900 }}>
        ...
        <div style={{ display: "flex", gap: "1.5rem", flexWrap: "wrap" }}>
          {links.map(l => (
            <a key={l} onClick={() => scrollToSection(l)} style={{ color: "rgba(224,247,255,0.5)", textDecoration: "none", fontSize: "0.85rem", transition: "color 0.2s", cursor: "pointer" }}
      ...
      <div style={{ textAlign: "center", marginTop: "2rem", paddingTop: "1.5rem", borderTop: "1px solid rgba(255,255,255,0.05)", color: "rgba(224,247,255,0.3)", fontSize: "0.78rem" }}>
...
function WhatsApp() {
  return (
    <motion.a
      ...
      animate={{ boxShadow: ["0 4px 20px rgba(37,211,102,0.4)", "0 4px 40px rgba(37,211,102,0.7)", "0 4px 20px rgba(37,211,102,0.4)"] }}
      transition={{ duration: 2.5, repeat: Infinity }}
      whileHover={{ scale: 1.12 }}
      style={{ position: "fixed", bottom: "2rem", right: "2rem", zIndex: 999, width: 56, height: 56, borderRadius: "50%", background: "linear-gradient(135deg,#25d366,#128c7e)", display: "flex", alignItems: "center", justifyContent: "center", textDecoration: "none" }}
    >
