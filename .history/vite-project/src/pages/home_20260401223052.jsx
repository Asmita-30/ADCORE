  ...
  return (
    <section
      ...
      style={{
        ...
        background: `linear-gradient(rgba(10, 15, 30, 0.85), rgba(10, 15, 30, 0.92)), url(${heroBg})`,
...
function Process() {
  ...
  return (
    <section style={{ 
      ...
      zIndex: 5, 
      padding: "80px 2rem", 
      background: `linear-gradient(rgba(17, 24, 39, 0.92), rgba(17, 24, 39, 0.96)), url(${processBg})`,
      backgroundSize: "cover",
      backgroundPosition: "center",
      backgroundAttachment: "fixed",
    }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          <div style={{
            display: "inline-block", background: "rgba(30, 58, 95, 0.9)",
            backdropFilter: "blur(8px)",
            borderRadius: 20,
            padding: "0.3rem 1rem", fontSize: "0.75rem", fontFamily: "'Inter', sans-serif",
            fontWeight: 500, color: C.blueHover, letterSpacing: "0.08em",
...
function About() {
  ...
  return (
    <section id="about" ref={sectionRef} style={{ 
      ...
      zIndex: 5, 
      padding: "100px 2rem", 
      background: `linear-gradient(rgba(10, 15, 30, 0.88), rgba(10, 15, 30, 0.94)), url(${aboutBg})`,
      backgroundSize: "cover",
      backgroundPosition: "center",
      backgroundAttachment: "fixed",
    }}>
...
function ServicesSection() {
  return (
    <section id="services" style={{ 
      ...
      background: `linear-gradient(rgba(17, 24, 39, 0.9), rgba(17, 24, 39, 0.95)), url(${servicesBg})`,
      backgroundSize: "cover",
      backgroundPosition: "center",
      backgroundAttachment: "fixed",
    }}>
          ...
          {SERVICES.map((svc, i) => (
            ...
            >
              <div style={{
                ...
                background: "rgba(30, 58, 95, 0.9)", display: "flex", alignItems: "center",
...
function Portfolio() {
  ...
  return (
    <section id="portfolio" ref={ref} style={{ 
      ...
      zIndex: 5, 
      padding: "80px 2rem 100px", 
      background: `linear-gradient(rgba(10, 15, 30, 0.85), rgba(10, 15, 30, 0.92)), url(${portfolioBg})`,
      backgroundSize: "cover",
      backgroundPosition: "center",
      backgroundAttachment: "fixed",
    }}>
          ...
          <Link to="/portfolio" style={{ textDecoration: "none" }}>
            <motion.button
              ...
              style={{
                background: "rgba(30, 41, 59, 0.8)",
                backdropFilter: "blur(8px)",
                border: `1px solid ${C.border}`, padding: "0.8rem 2rem",
...
function Pricing() {
  return (
    <section id="pricing" style={{ 
      ...
      zIndex: 5, 
      padding: "80px 2rem 100px", 
      background: `linear-gradient(rgba(17, 24, 39, 0.88), rgba(17, 24, 39, 0.94)), url(${pricingBg})`,
      backgroundSize: "cover",
      backgroundPosition: "center",
      backgroundAttachment: "fixed",
    }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
                <Link to="/pricing" style={{ textDecoration: "none" }}>
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    style={{
                      width: "100%", background: plan.popular ? C.blue : "rgba(37, 99, 235, 0.8)",
...
function Blog() {
  ...
  return (
    <section id="blog" ref={ref} style={{ 
      ...
      zIndex: 5, 
      padding: "80px 2rem 100px", 
      background: `linear-gradient(rgba(10, 15, 30, 0.85), rgba(10, 15, 30, 0.92)), url(${blogBg})`,
      backgroundSize: "cover",
      backgroundPosition: "center",
      backgroundAttachment: "fixed",
    }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "1.5rem" }}>
          {BLOG_POSTS.map((post) => (
            <motion.article
              ...
              style={{
                opacity: 0, background: "rgba(17, 24, 39, 0.8)",
                backdropFilter: "blur(8px)",
                border: `1px solid ${C.border}`,
...
function Contact() {
  ...
  return (
    <section id="contact" ref={ref} style={{ 
      ...
      zIndex: 5, 
      padding: "80px 2rem 100px", 
      background: `linear-gradient(rgba(17, 24, 39, 0.85), rgba(17, 24, 39, 0.92)), url(${contactBg})`,
      backgroundSize: "cover",
      backgroundPosition: "center",
      backgroundAttachment: "fixed",
    }}>
