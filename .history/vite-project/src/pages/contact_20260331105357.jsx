...
const handleSubmit = async (e) => {
  ...
  // ✅ FIXED: Added to_email parameter (CRITICAL)
  // Template params for admin notification (template_ewwsopp)
  const adminTemplateParams = {
    to_email: "adrixcoretech@gmail.com",  // ⭐⭐⭐ MUST HAVE - Recipient email
  ...
  const autoReplyParams = {
    to_email: formData.email,  // ⭐⭐⭐ MUST HAVE - Client's email
  ...
  try {
    // ✅ Using service_ozdijes (Gmail API)
    ...
    console.log("Template ID:", adminTemplateId);
