        ...
        <motion.div style={{ opacity, scale }} className="hero-animate" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
          <div style={{ textAlign: "center", maxWidth: 900, margin: "0 auto" }}>
            ...
            >
              ...
              <span style={{ color: C.cyan }}>You Lead. We Build. Together We Win</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Great Ideas Deserve Great Execution — Every Time..
            </motion.p>
          </div>
        </motion.div>
      </section>
      ...
      <section style={{ padding: "80px 2rem", position: "relative", zIndex: 2 }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", textAlign: "center" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "1rem", justifyContent: "center" }}>
            {["Java", "Spring Boot", "React", "TypeScript", "PostgreSQL", "React Native", "AWS", "Docker", "Figma", "Next.js", "Tailwind CSS", "Claude API","MySql","Html5","Css","bootstrap","php","javascript"].map((tech, i) => (
              <motion.div
                key={tech}
