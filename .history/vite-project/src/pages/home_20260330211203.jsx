...
const CARD_POS = {
  "left":          { top: "28%", left: "0%", transform: "translateY(-50%)" },
  "right":         { top: "28%", right: "0%", transform: "translateY(-50%)" },
  "bottom-left":   { bottom: "12%", left: "5%" },
  "bottom":        { bottom: "2%", left: "50%", transform: "translateX(-50%)" },
  "bottom-right":  { bottom: "12%", right: "5%" },
  "right-bottom":  { bottom: "38%", right: "0%", transform: "translateY(50%)" },
};
          ...
          >
            ...
            <div style={{
              ...
              <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
                <path d="M1.5 5h7M5 1.5l3.5 3.5L5 8.5" stroke={svc.color} strokeWidth="1" strokeLinecap="round"/>
              </svg>
            </div>
            ...
            <motion.div
              ...
              style={{
                position: "absolute",
                [svc.pos === "left" ? "right" : svc.pos === "right" ? "left" : "bottom"]: "-6px",
