...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Prepare email data for main notification
    ...
    // Prepare auto-reply email to client
    ...
    try {
      ...
      const mainTemplateId = "template_contact";
      const autoReplyTemplateId = "template_auto_reply";
      
      console.log("Sending email...");
      
      // Send main notification email
      const response1 = await emailjs.send(serviceId, mainTemplateId, templateParams);
      console.log("Main email response:", response1);
      
      // Send auto-reply to client
      const response2 = await emailjs.send(serviceId, autoReplyTemplateId, autoReplyParams);
      console.log("Auto-reply response:", response2);
