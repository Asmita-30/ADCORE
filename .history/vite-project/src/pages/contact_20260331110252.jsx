...
const handleSubmit = async (e) => {
  ...
  // ✅ Admin Template Params (to ADRIX CORE)
  ...
  // ✅ Auto-Reply Template Params (to CLIENT) - FIXED
  const autoReplyParams = {
    to_email: formData.email,  // ⭐ This MUST be the client's email (asmitabhadane8@gmail.com)
