...
{/* Center Hub - Moved to y=150 - Larger Circles */}
<g filter="url(#wg)">
  {/* Outer glow circle */}
  <circle cx="450" cy="150" r="70" fill="url(#grad1)" opacity="0.08" />
  
  {/* Main outer ring */}
  <circle cx="450" cy="150" r="60" fill="rgba(0,229,255,0.05)" stroke={C.cyan} strokeWidth="1.8" strokeDasharray="4 4" />
  
  {/* Middle solid circle */}
  <circle cx="450" cy="150" r="48" fill="rgba(0,229,255,0.1)" stroke={C.cyan} strokeWidth="1.2" />
  
  {/* Inner core circle */}
  <circle cx="450" cy="150" r="35" fill="rgba(0,229,255,0.18)" />
  
  {/* OUR text - Larger */}
  <text x="450" y="143" textAnchor="middle" fill={C.cyan} fontSize="14" fontFamily="'Orbitron',monospace" fontWeight="bold" letterSpacing="1">
    OUR
  </text>
  
  {/* SERVICES text - Larger */}
  <text x="450" y="165" textAnchor="middle" fill={C.cyan} fontSize="14" fontFamily="'Orbitron',monospace" fontWeight="bold" letterSpacing="1">
    SERVICES
  </text>
</g>
</svg>
