      ...
      <section style={{ padding: "60px 2rem", background: "rgba(0,5,15,0.3)", position: "relative", zIndex: 2 }}>
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
          ...
          >
           ...
           {/* Blog Post Modal - FIXED: Full overlay hides everything */}
      {selectedPost && (
        <div style={{
          position: "fixed",
          top: 0,
          ...
          right: 0,
          bottom: 0,
          background: "#020408",  // Changed to solid dark color instead of rgba
          zIndex: 9999,           // Increased z-index to ensure it's above everything
          overflowY: "auto",
          backdropFilter: "blur(0px)"  // Removed blur for cleaner look
