...
const CARD_POS = {
  "left":          { top: "15%", left: "0%", transform: "translateY(-50%)" },
  "left-bottom":   { bottom: "5%", left: "0%", transform: "translateY(50%)" },
  "right-top":     { top: "15%", right: "0%", transform: "translateY(-50%)" },
  "right":         { bottom: "5%", right: "0%", transform: "translateY(50%)" },
  "bottom-center": { bottom: "0%", left: "35%", transform: "translateX(-50%)" },
};
    ...
    <section ref={sectionRef} id="services" style={{ 
      ...
      <div style={{ 
        ...
        <svg viewBox="0 0 900 600" style={{ 
         ...
         {/* Center Hub */}
<g filter="url(#wg)">
  <circle cx="450" cy="300" r="55" fill="url(#grad1)" opacity="0.12" />
  <circle cx="450" cy="300" r="45" fill="rgba(0,229,255,0.08)" stroke={C.cyan} strokeWidth="1.5" />
  <circle cx="450" cy="300" r="35" fill="rgba(0,229,255,0.15)" />
  
  {/* OUR text */}
  <text x="450" y="295" textAnchor="middle" fill={C.cyan} fontSize="12" fontFamily="'Orbitron',monospace" fontWeight="bold">
    OUR
  </text>
  
  {/* SERVICES text */}
  <text x="450" y="312" textAnchor="middle" fill={C.cyan} fontSize="12" fontFamily="'Orbitron',monospace" fontWeight="bold">
    SERVICES
  </text>
</g>
        </svg>
        ...
        {SERVICES.map((svc, i) => (
          <motion.div
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow = `0 8px 25px ${svc.color}20`;
            }}
            onMouseLeave={(e) => {
          ...
          >
            ...
            <div style={{
              ...
              <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                <path d="M2 6h8M6 2l4 4-4 4" stroke={svc.color} strokeWidth="1.2" strokeLinecap="round"/>
              </svg>
            </div>
            ...
            <motion.div
              ...
              style={{
                position: "absolute",
                [svc.pos === "left" || svc.pos === "left-bottom" ? "right" : svc.pos === "right-top" || svc.pos === "right" ? "left" : "top"]: "-8px",
