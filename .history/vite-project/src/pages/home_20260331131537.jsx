...
import heroImg from "../assets/images/adrixcoremiddle.png";
import ecommerceImg from "../assets/images/ecommerce.jpg";
import financeImg from "../assets/images/finance-app.jpg";
import aiImg from "../assets/images/ai-analytics.jpg";
...
function Hero() {
  ...
  return (
    <section id="home" style={{
      ...
      {/* Logo Arena */}
      <motion.div
        style={{ opacity: logoOpacity, y: logoY, position: "relative", zIndex: 5, marginBottom: "1rem" }}
      >
        <div style={{
          position: "relative",
          width: 520,
          ...
          {/* Center Image - Just the image, no effects */}
          <img
            src={heroImage}
            alt="Adrix Core"
            style={{
          ...
          <motion.div
            ...
            style={{
              position: "absolute", right: "calc(100% + 24px)", top: "35%", transform: "translateY(-65%)",
              textAlign: "right", whiteSpace: "nowrap",
            }}
          >
            <div style={{ fontFamily: "'Orbitron',monospace", fontWeight: 900, fontSize: "5rem", color: "#fff", letterSpacing: "0.04em" }}>
              ADRIX
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            transition={{ delay: 0.6, duration: 0.8 }}
            style={{
              position: "absolute", left: "calc(100% + 24px)", top: "35%", transform: "translateY(-65%)",
              whiteSpace: "nowrap",
            }}
          >
            <div style={{ fontFamily: "'Orbitron',monospace", fontWeight: 900, fontSize: "5rem", color: C.cyan, letterSpacing: "0.04em" }}>
              CORE
            </div>
          </motion.div>
        </div>
      ...
      {/* Search Bar - Moved Up and Width Increased */}
      <motion.div
        style={{ opacity: searchOpacity, position: "relative", zIndex: 5, width: "min(850px,90vw)", marginTop: "-1rem" }}
      ...
      <motion.div
        ...
        style={{ display: "flex", gap: "3rem", marginTop: "1.5rem", flexWrap: "wrap", justifyContent: "center", zIndex: 5 }}
      >
...
{/* Center Hub - Extra Large Single Circle with Dark Text */}
<g filter="url(#wg)">
  {/* Main Large Circle */}
  <circle cx="450" cy="150" r="95" fill="rgba(242, 247, 248, 0.1)" stroke={C.cyan} strokeWidth="2.2" />
  
  {/* Inner Glow */}
  <circle cx="450" cy="150" r="82" fill="rgba(248, 249, 250, 0.06)" />
  
  {/* OUR text - Dark Color */}
  <text x="450" y="140" textAnchor="middle" fill="#f9f9fa" fontSize="18" fontFamily="'Orbitron',monospace" fontWeight="bold" letterSpacing="2">
    OUR
  </text>
  
  {/* SERVICES text - Dark Color */}
  <text x="450" y="167" textAnchor="middle" fill="#f1f2f6" fontSize="18" fontFamily="'Orbitron',monospace" fontWeight="bold" letterSpacing="2">
    SERVICES
  </text>
</g>
</svg>
...
const PROJECTS = [
{ 
  image: "/images/web-development.jpg",  // Replace with your actual image path
  label: "Web Development", 
  title: "E-Commerce Platform", 
  grad: "linear-gradient(135deg,#051228,#150830)",
  liveUrl: "https://shopease-demo.com",
  docUrl: "/documents/ecommerce-platform-case-study.pdf"
},
{ 
  image: "/images/mobile-app.jpg",  // Replace with your actual image path
  label: "Mobile App", 
  title: "Finance Mobile App", 
  grad: "linear-gradient(135deg,#051820,#001535)",
  liveUrl: "https://moneyflow-demo.com",
  docUrl: "/documents/finance-app-case-study.pdf"
},
{ 
  image: "/images/ai-analytics.jpg",  // Replace with your actual image path
  label: "AI Integration", 
  title: "AI Analytics Dashboard", 
  grad: "linear-gradient(135deg,#18051a,#0a0a35)",
  liveUrl: "https://dataviz-demo.com",
  docUrl: "/documents/ai-analytics-case-study.pdf"
},
  // { 
  //   emoji: "⚡", 
  //   label: "SaaS Platform", 
  //   title: "Port Management System", 
  //   grad: "linear-gradient(135deg,#001525,#0a1a2e)",
  //   liveUrl: "https://pmas-demo.com",
  //   docUrl: "/documents/port-management-case-study.pdf"
  // },
];
...
function Portfolio() {
  ...
  const handleDownload = (docUrl, title) => {
    // Create a temporary anchor element
    const link = document.createElement('a');
    link.href = docUrl;
    link.download = `${title.toLowerCase().replace(/\s+/g, '-')}-case-study.pdf`;
          ...
          >
            <div style={{ height: 260, background: p.grad, display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
              ...
              <motion.div
                ...
                style={{ position: "absolute", inset: 0, background: "rgba(0,0,0,0.88)", display: "flex", alignItems: "center", justifyContent: "center", gap: "1rem", flexDirection: "column" }}
              >
                {/* Live Preview Button */}
                <motion.a
                  href={p.liveUrl}
                ...
                <motion.button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    handleDownload(p.docUrl, p.title);
                  }}
                >
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7 1v8M4 6l3 3 3-3" stroke={C.cyan} strokeWidth="1.5" strokeLinecap="round"/>
                    <path d="M1 10v2a1 1 0 001 1h10a1 1 0 001-1v-2" stroke={C.cyan} strokeWidth="1.5" strokeLinecap="round"/>
                  </svg>
                  Download PDF
                </motion.button>
              </motion.div>
...
// src/pages/home.jsx - Pricing Section
...
function Pricing() {
  ...
  return (
    <section id="pricing" style={{ position: "relative", zIndex: 5, padding: "60px 2rem 80px", background: "rgba(0,5,15,0.3)" }}>
      <div style={{ textAlign: "center", marginBottom: "2rem" }}>
        ...
        <p style={{ color: "rgba(224,247,255,0.5)", marginTop: "0.5rem", fontSize: "0.9rem" }}>
        ...
        {PRICING_PLANS.map((plan, i) => (
          <motion.div
            ...
            style={{
              ...
              padding: "1.8rem",
              position: "relative",
              boxShadow: plan.popular ? `0 0 40px ${plan.color}20` : "0 4px 20px rgba(0,0,0,0.2)",
              backdropFilter: "blur(10px)",
              transition: "all 0.3s ease"
            }}
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.8rem", marginBottom: "1rem" }}>
              ...
              <div>
                ...
                <p style={{ fontSize: "0.7rem", color: "rgba(224,247,255,0.5)" }}>{plan.tagline}</p>
              </div>
            </div>
            
            {/* Price */}
            <div style={{ marginBottom: "1rem" }}>
              <span style={{ fontFamily: "'Orbitron',monospace", fontSize: "1.6rem", fontWeight: 900, color: "#fff" }}>
                {plan.price}
              </span>
              <span style={{ fontSize: "0.7rem", color: "rgba(224,247,255,0.5)", marginLeft: "0.2rem" }}>/ project</span>
            </div>
            ...
            <div style={{ 
              ...
              <span style={{ fontSize: "0.7rem", color: C.cyan }}>⏱️ {plan.timeline}</span>
            </div>
            ...
            <div style={{ marginBottom: "1.5rem" }}>
              {plan.features.slice(0, 4).map((feature, idx) => (
                <div key={idx} style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.4rem" }}>
                  ...
                  <span style={{ fontSize: "0.75rem", color: "rgba(224,247,255,0.7)" }}>{feature}</span>
                </div>
              ))}
              {plan.features.length > 4 && (
                <p style={{ fontSize: "0.7rem", color: "rgba(224,247,255,0.4)", marginTop: "0.3rem" }}>
...
const BLOG_POSTS = [
  { 
    ...
    excerpt: "Explore emerging trends like AI-driven development, WebAssembly, and edge computing.", 
    date: "Mar 15, 2026", 
    readTime: "5 min read", 
    category: "Trends",
    image: blogImg1,
  ...
  { 
    id: 3, 
    title: "AI Integration: A Game Changer for Businesses", 
...
function Blog() {
  ...
  return (
    <section id="blog" ref={ref} style={{ position: "relative", zIndex: 5, padding: "80px 3rem 100px", background: "rgba(0,5,15,0.3)" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(350px,1fr))", gap: "2rem", maxWidth: 1200, margin: "0 auto" }}>
        {BLOG_POSTS.map((post, i) => (
          ...
          >
            ...
            <div style={{ padding: "1.5rem" }}>
              ...
              <h3 style={{ fontFamily: "'Orbitron',monospace", fontSize: "1.2rem", fontWeight: 700, marginBottom: "0.5rem", color: "#fff", lineHeight: 1.4 }}>
                {post.title}
              </h3>
              <p style={{ color: "rgba(224,247,255,0.7)", fontSize: "0.85rem", lineHeight: 1.5, marginBottom: "1rem" }}>
                {post.excerpt}
              </p>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ color: "rgba(224,247,255,0.5)", fontSize: "0.7rem" }}>⏱️ {post.readTime}</span>
                <span style={{ color: C.cyan, fontSize: "0.8rem", fontWeight: 600, display: "flex", alignItems: "center", gap: "0.3rem" }}>
                  Read more 
                  <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                    <path d="M2 6h8M6 2l4 4-4 4" stroke={C.cyan} strokeWidth="1.2" strokeLinecap="round"/>
                  </svg>
                </span>
              </div>
            </div>
