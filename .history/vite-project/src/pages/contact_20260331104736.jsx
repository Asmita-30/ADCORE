...
const handleSubmit = async (e) => {
  ...
  // IMPORTANT: These variables MUST match your EmailJS template variables exactly
  // For template_ewwsopp (Contact Us - Admin Notification)
  const adminTemplateParams = {
    to_email: "adrixcoretech@gmail.com",  // ⭐ CRITICAL: Add recipient email
  ...
  // For template_cqwbt4h (Auto-Reply to Client)
  const autoReplyParams = {
    to_email: formData.email,  // ⭐ CRITICAL: Client's email
