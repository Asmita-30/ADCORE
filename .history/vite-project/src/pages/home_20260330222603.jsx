    ...
    <section id="home" style={{
      ...
      >
        <div style={{
          ...
          >
            <div style={{ fontFamily: "'Orbitron',monospace", fontWeight: 900, fontSize: "6rem", color: "#fff", letterSpacing: "0.04em" }}>
              ADRIX
            </div>
          </motion.div>
          ...
          >
            <div style={{ fontFamily: "'Orbitron',monospace", fontWeight: 900, fontSize: "6rem", color: C.cyan, letterSpacing: "0.04em" }}>
              CORE
            </div>
          </motion.div>
        </div>
