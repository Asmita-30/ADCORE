...
{/* Center Hub - Single Large Circle */}
<g filter="url(#wg)">
  {/* Single Large Circle */}
  <circle cx="450" cy="150" r="75" fill="rgba(0,229,255,0.12)" stroke={C.cyan} strokeWidth="2" />
  
  {/* Inner Glow */}
  <circle cx="450" cy="150" r="65" fill="rgba(0,229,255,0.08)" />
  
  {/* OUR text */}
  <text x="450" y="143" textAnchor="middle" fill={C.cyan} fontSize="16" fontFamily="'Orbitron',monospace" fontWeight="bold" letterSpacing="1.5">
    OUR
  </text>
  
  {/* SERVICES text */}
  <text x="450" y="167" textAnchor="middle" fill={C.cyan} fontSize="16" fontFamily="'Orbitron',monospace" fontWeight="bold" letterSpacing="1.5">
    SERVICES
  </text>
</g>
</svg>
