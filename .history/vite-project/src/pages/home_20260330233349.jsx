...
{/* Center Hub - Extra Large Single Circle */}
<g filter="url(#wg)">
  {/* Main Large Circle */}
  ...
  {/* OUR text */}
  <text x="450" y="140" textAnchor="middle" fill={C.cyan} fontSize="18" fontFamily="'Orbitron',monospace" fontWeight="bold" letterSpacing="2">
    OUR
  </text>
  
  {/* SERVICES text */}
  <text x="450" y="167" textAnchor="middle" fill={C.cyan} fontSize="18" fontFamily="'Orbitron',monospace" fontWeight="bold" letterSpacing="2">
    SERVICES
  </text>
</g>
</svg>
