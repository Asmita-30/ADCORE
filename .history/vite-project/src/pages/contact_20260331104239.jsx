...
const handleSubmit = async (e) => {
  ...
  // Template params for admin notification (template_ewwsopp)
  // Make sure these match EXACTLY with your EmailJS template variables
  const adminTemplateParams = {
    to_name: "ADRIX CORE Team",
  ...
  // Template params for auto-reply to client (template_cqwbt4h)
...
Time: ${formattedDate}`;
  ...
  try {
    ...
    if (adminResponse.status === 200) {
      ...
      // 3. Send WhatsApp notification (optional - opens in new tab)
      const whatsappMessage = `🔔 *NEW LEAD - ADRIX CORE* 🔔
...
Please check email for complete details.`;
      
      // Open WhatsApp in new tab (optional - uncomment if needed)
      // const encodedWhatsapp = encodeURIComponent(whatsappMessage);
      // window.open(`https://wa.me/917447508006?text=${encodedWhatsapp}`, "_blank");
