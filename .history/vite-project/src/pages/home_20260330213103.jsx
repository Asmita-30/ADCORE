...
const CARD_POS = {
  "left":          { top: "18%", left: "0%", transform: "translateY(-50%)" },
  "left-bottom":   { bottom: "8%", left: "0%", transform: "translateY(50%)" },
  "right-top":     { top: "18%", right: "0%", transform: "translateY(-50%)" },
  "right":         { bottom: "8%", right: "0%", transform: "translateY(50%)" },
    ...
    <section ref={sectionRef} id="services" style={{ 
      ...
      <div style={{ 
        ...
        <svg viewBox="0 0 900 550" style={{ 
          ...
          {/* Center Hub */}
          <g filter="url(#wg)">
            <circle cx="450" cy="275" r="55" fill="url(#grad1)" opacity="0.12" />
            <circle cx="450" cy="275" r="45" fill="rgba(0,229,255,0.08)" stroke={C.cyan} strokeWidth="1.5" />
            <circle cx="450" cy="275" r="35" fill="rgba(0,229,255,0.15)" />
            
            {/* OUR text */}
            <text x="450" y="270" textAnchor="middle" fill={C.cyan} fontSize="12" fontFamily="'Orbitron',monospace" fontWeight="bold">
              OUR
            </text>
            
            {/* SERVICES text */}
            <text x="450" y="287" textAnchor="middle" fill={C.cyan} fontSize="12" fontFamily="'Orbitron',monospace" fontWeight="bold">
              SERVICES
            </text>
          </g>
        </svg>
