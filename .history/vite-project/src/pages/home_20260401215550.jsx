...
function Process() {
  ...
  return (
    <section style={{ position: "relative", zIndex: 5, padding: "80px 2rem", background: C.surface }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          <div style={{
            display: "inline-block", background: "#1E3A5F", borderRadius: 20,
            ...
            >
              ...
              {i < steps.length - 1 && (
                <div style={{
                  ...
                  color: C.border, fontSize: "1.2rem",
...
function About() {
  ...
  return (
    <section id="about" ref={sectionRef} style={{ position: "relative", zIndex: 5, padding: "100px 2rem", background: C.bg }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
...
function ServicesSection() {
  return (
    <section id="services" style={{ position: "relative", zIndex: 5, padding: "80px 2rem 100px", background: C.surface }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          <div style={{
            display: "inline-block", background: "#1E3A5F", borderRadius: 20,
...
function Portfolio() {
  ...
  return (
    <section id="portfolio" ref={ref} style={{ position: "relative", zIndex: 5, padding: "80px 2rem 100px", background: C.bg }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          <div style={{
            display: "inline-block", background: "#1E3A5F", borderRadius: 20,
...
function Pricing() {
  return (
    <section id="pricing" style={{ position: "relative", zIndex: 5, padding: "80px 2rem 100px", background: C.surface }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          <div style={{
            display: "inline-block", background: "#1E3A5F", borderRadius: 20,
...
function Blog() {
  ...
  return (
    <section id="blog" ref={ref} style={{ position: "relative", zIndex: 5, padding: "80px 2rem 100px", background: C.bg }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          <div style={{
            display: "inline-block", background: "#1E3A5F", borderRadius: 20,
...
function Contact() {
  ...
  return (
    <section id="contact" ref={ref} style={{ position: "relative", zIndex: 5, padding: "80px 2rem 100px", background: C.surface }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          <div style={{
            display: "inline-block", background: "#1E3A5F", borderRadius: 20,
