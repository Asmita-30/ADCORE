...
const PROJECTS_DATA = [
  {
    ...
    downloadUrl: "/documents/port-management-case-study.pdf",
  ...
  },
  {
    ...
    downloadUrl: "/documents/fintech-app-case-study.pdf",
  ...
  },
  {
    ...
    downloadUrl: "/documents/ai-analytics-case-study.pdf",
  ...
  },
  {
    ...
    downloadUrl: "/documents/ecommerce-platform-case-study.pdf",
  ...
  },
  {
    ...
    downloadUrl: "/documents/healthcare-management-case-study.pdf",
  ...
  },
  {
    ...
    downloadUrl: "/documents/edtech-platform-case-study.pdf",
...
function Portfolio() {
  ...
  const getPersonalizedProjects = (projects) => {
    if (!selectedIndustry) return projects;
  ...
  const displayedProjects = getPersonalizedProjects(filteredProjects);
  ...
  const handleDownload = (downloadUrl, projectName) => {
    ...
    link.download = `${projectName.toLowerCase().replace(/\s+/g, '-')}-case-study.pdf`;
      ...
      <section style={{ padding: "2rem 2rem 0", position: "relative", zIndex: 2 }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <div style={{ position: "relative" }}>
            <input
              type="text"
              placeholder="Search projects by name, client, industry, technology... (e.g., 'E-commerce', 'Healthcare', 'React')"
              value={searchQuery}
          ...
          {searchQuery && (
            <div style={{ textAlign: "center", marginTop: "0.5rem" }}>
              <span style={{ fontSize: "0.75rem", color: "rgba(224,247,255,0.5)" }}>
                Found {displayedProjects.length} project(s) matching "{searchQuery}"
              </span>
            </div>
          )}
        </div>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          {displayedProjects.length === 0 ? (
            <div style={{ textAlign: "center", padding: "4rem" }}>
              <p style={{ color: "rgba(224,247,255,0.6)" }}>No projects found matching your search.</p>
            </div>
          ) : (
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: "0.5rem" }}>
                      ...
                      >
                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                          <path d="M2 6h8M6 2l4 4-4 4" stroke="white" strokeWidth="1" strokeLinecap="round"/>
                        </svg>
                        Live Preview
                      </motion.button>
                      <motion.button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          handleDownload(project.downloadUrl, project.name);
                        }}
                        style={{
                      ...
                      >
                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                          <path d="M6 1v6M4 5l2 2 2-2" stroke={C.cyan} strokeWidth="1" strokeLinecap="round"/>
                          <path d="M1 8v2a1 1 0 001 1h8a1 1 0 001-1V8" stroke={C.cyan} strokeWidth="1" strokeLinecap="round"/>
                        </svg>
                        Download PDF
                      </motion.button>
                    </div>
          ...
          >
            ...
            <div style={{ marginBottom: "2rem", textAlign: "center" }}>
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={() => handleDownload(selectedProject.downloadUrl, selectedProject.name)}
                style={{
                  background: "transparent",
                  border: `1px solid ${C.cyan}`,
                  padding: "0.8rem 2rem",
