...
<g filter="url(#wg)">
  {/* Main Large Circle */}
  <circle cx="450" cy="150" r="95" fill="rgba(0,229,255,0.1)" stroke={C.cyan} strokeWidth="2.2" />
  
  {/* Inner Glow */}
  <circle cx="450" cy="150" r="82" fill="rgba(0,229,255,0.06)" />
  
  {/* OUR text - Dark Color */}
  <text x="450" y="140" textAnchor="middle" fill="#0D1B3E" fontSize="18" fontFamily="'Orbitron',monospace" fontWeight="bold" letterSpacing="2">
    OUR
  </text>
