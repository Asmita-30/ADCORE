...
import pmasImg from "../assets/images/E-commerce.png";
import jansahayakImg from "../assets/images/team.jpeg";
...
// Updated PROJECTS_DATA with correct live preview links
const PROJECTS_DATA = [
  {
    id: 1,
    ...
    liveUrl: "https://sainfotechs.com/", // Link for SA Infotechs website
    challenge: "The Maharashtra Maritime Board was managing port operations using manual processes...",
    solution: "Built a unified Port Management Automation System (PMAS) that digitized all port operations...",
    architecture: "Microservices architecture with React frontend, Spring Boot backend...",
    features: [
  ...
  },
  {
    ...
    liveUrl: "https://transport-ashy.vercel.app/", // Link for Transport website
    challenge: "Citizens had to visit government offices multiple times for scheme applications...",
    solution: "Built a comprehensive citizen portal allowing online applications, document uploads...",
  ...
  },
  {
    ...
    isRealProject: false,
    isSample: true,
    description: "A fully responsive e-commerce template with product catalog and cart.",
    techStack: ["HTML/CSS", "JavaScript", "Wix Platform"],
    liveUrl: "https://www.wix.com/website-template/view/html/wh-1064", // E-commerce template link
    sampleNote: "This is a concept project demonstrating our e-commerce capabilities.",
    features: [
  ...
  {
    id: 4,
    name: "FinWise - Personal Finance App",
    client: "Sample Project",
    category: "mobile",
    industry: "FinTech",
    year: "2026",
    ...
    isRealProject: false,
    isSample: true,
    description: "A personal finance management app template to track expenses and budgets.",
    techStack: ["Jotform", "Mobile App Builder"],
    liveUrl: "https://www.jotform.com/app-templates/personal-finance-management-app", // Finance app template link
    sampleNote: "This is a concept project demonstrating a personal finance app flow.",
    features: [
  ...
  {
    id: 5,
    name: "DataViz AI Analytics Dashboard",
    client: "Sample Project",
    category: "ai",
    industry: "SaaS",
    year: "2026",
    ...
    isRealProject: false,
    isSample: true,
    description: "An AI-powered analytics dashboard template for business intelligence.",
    techStack: ["React", "Chart.js", "Tailadmin Template"],
    liveUrl: "https://tailadmin.com/blog/best-analytics-dashboard", // AI Dashboard link
    sampleNote: "This is a concept project demonstrating an AI analytics dashboard.",
    features: [
...
function Portfolio() {
  ...
  return (
    <>
      ...
      {/* Search Bar and Filters (Code remains the same as your original) */}
      {/* ... (Search Bar and Filter Bar JSX - unchanged) ... */}
      {/* Search Bar */}
      ...
      {/* Portfolio Grid with Updated Buttons */}
                      ...
                      <motion.button
                        ...
                        onClick={(e) => {
                          ...
                          if (project.liveUrl && project.liveUrl !== "#") {
                            ...
                            alert("Live preview link is not available for this project.");
                          }
                        }}
                        style={{
      ...
      {/* Project Modal (Remains the same as your original) */}
      {selectedProject && ( ... )} {/* Keep your modal code as is */}
    </>
  );
}
