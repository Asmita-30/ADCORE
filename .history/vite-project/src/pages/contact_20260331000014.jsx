...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const serviceId = "service_adrixcore"; // Replace with your service ID
      ...
      if (response.status === 200) {
        ...
        // Also send notification to phone via SMS (using SMS API)
        // This requires additional setup with services like Twilio, etc.
        // For now, we'll send an email notification that can be forwarded to SMS
