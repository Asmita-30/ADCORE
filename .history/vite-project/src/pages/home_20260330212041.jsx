...
const CARD_POS = {
  ...
  "bottom-center": { bottom: "10%", left: "30%", transform: "translateX(-50%)" },
};
    ...
    <section ref={sectionRef} id="services" style={{ 
      ...
      <div style={{ 
        ...
        <svg viewBox="0 0 900 600" style={{ 
          ...
          {/* Center Hub */}
          <g filter="url(#wg)">
            <circle cx="450" cy="300" r="42" fill="url(#grad1)" opacity="0.12" />
            <circle cx="450" cy="300" r="32" fill="rgba(0,229,255,0.08)" stroke={C.cyan} strokeWidth="1.2" />
            <circle cx="450" cy="300" r="22" fill="rgba(0,229,255,0.15)" />
            <text x="450" y="305" textAnchor="middle" fill={C.cyan} fontSize="10" fontFamily="'Orbitron',monospace" fontWeight="bold">
              CORE
            </text>
          </g>
        </svg>
