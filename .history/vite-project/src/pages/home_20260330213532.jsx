...
const CARD_POS = {
  "left":          { top: "12%", left: "0%", transform: "translateY(-50%)" },
  "left-bottom":   { bottom: "18%", left: "0%", transform: "translateY(50%)" },
  "right-top":     { top: "12%", right: "0%", transform: "translateY(-50%)" },
  "right":         { bottom: "18%", right: "0%", transform: "translateY(50%)" },
    ...
    <section ref={sectionRef} id="services" style={{ 
      ...
      <div style={{ 
        ...
        <svg viewBox="0 0 900 560" style={{ 
          ...
          {/* Center Hub - Moved Up */}
          <g filter="url(#wg)">
            <circle cx="450" cy="200" r="50" fill="url(#grad1)" opacity="0.12" />
            <circle cx="450" cy="200" r="40" fill="rgba(0,229,255,0.08)" stroke={C.cyan} strokeWidth="1.5" />
            <circle cx="450" cy="200" r="30" fill="rgba(0,229,255,0.15)" />
            
            {/* OUR text */}
            <text x="450" y="195" textAnchor="middle" fill={C.cyan} fontSize="11" fontFamily="'Orbitron',monospace" fontWeight="bold">
              OUR
            </text>
            
            {/* SERVICES text */}
            <text x="450" y="212" textAnchor="middle" fill={C.cyan} fontSize="11" fontFamily="'Orbitron',monospace" fontWeight="bold">
              SERVICES
            </text>
          </g>
        </svg>
