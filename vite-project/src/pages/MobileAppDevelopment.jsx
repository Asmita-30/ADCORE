...
import mobileAppHeroBg from "../assets/images/mobileapp-bg.png";
...
// Service-specific gradient for hero (Mobile App)
const serviceGradient = {
  mobileapp: "radial-gradient(circle at 20% 30%, rgba(37, 99, 235, 0.12) 0%, transparent 60%), radial-gradient(circle at 70% 80%, rgba(6, 182, 212, 0.08) 0%, transparent 60%)"
};
...
function MobileAppDevelopment() {
  ...
  // Tech stack with logos and platform badges
  const techStack = [
    { name: "React Native", logo: "⚛️", color: "#61DAFB", platform: "Cross-Platform" },
    { name: "Flutter", logo: "🦋", color: "#02569B", platform: "Cross-Platform" },
    { name: "Swift", logo: "🍎", color: "#FA7343", platform: "iOS" },
    { name: "Kotlin", logo: "📱", color: "#7F52FF", platform: "Android" },
    { name: "Firebase", logo: "🔥", color: "#FFCA28", platform: "Backend" },
    { name: "Node.js", logo: "🟢", color: "#68A063", platform: "Backend" }
  ];
  ...
  const pricingPreview = {
    ...
    priceRange: "₹79,999 - Custom",
    description: "Fixed-price quotes. Includes app store submission."
  };
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          >
            ...
            <h2 style={{ 
              ...
              Mobile Apps For <span style={{ color: COLORS.primaryAccent }}>Every Industry</span>
            </h2>
          </motion.div>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          >
            ...
            <h2 style={{ 
              ...
              How We Build Your <span style={{ color: COLORS.primaryAccent }}>App</span>
            </h2>
          </motion.div>
